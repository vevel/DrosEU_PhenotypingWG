---
title: "**GitHub respository for manuscript entitled 'Continent-wide differentiation of fitness traits and patterns of climate adaptation among European populations of _Drosophila melanogaster_'** " 
...
Contents of the repository, raw data, tables, figures and scripts can be found [here](https://github.com/esradm/DrosEU_PhenotypingWG)
...
## 1.1 General overview of the phenotyping effort
...
droseu_coord <- read.csv("InfoTables/TableS1.csv", sep = ";") %>%
  select(!LineID_month)
```
...
droseu_labs <- data.frame(read.csv("InfoTables/TableS2.csv"))
```

```{r echo=FALSE}
knitr::kable(droseu_labs, allign = "llll", caption = "Table S2. Contributing labs and traits, sorted by trait. Author contributions can be found [here](https://docs.google.com/spreadsheets/d/1SkiqZlpZlEs1nf6JJUakREYS4mpghSmgb_0QlL8o3ek/edit#gid=1616763697)")
```
...
## 1.2 - Drosophila population samples, isofemale lines, and stock maintenance
...
## 1.4 - Chromosomal inversion frequencies
...
## 1.5 - Trait-specific assay conditions and measurements
...
##### Bergland, Flatt and Schlötterer Labs
...
glmers_sum <- readRDS("LinearModelsPop/all_glmers_pop_summary_list.rds")
...
knitr::include_graphics("Viability/p_Via_pop_lab.png")
```
...
knitr::include_graphics("Viability/p_Via_pop_batch_Gibert.png")
knitr::include_graphics("Viability/p_Via_pop_lm_Gibert.png")
```
...
```{r echo=FALSE, fig.show="hold", out.width="49%"}
knitr::include_graphics("Viability/p_Via_pop_batch_Grath.png")
knitr::include_graphics("Viability/p_Via_pop_lm_Grath.png")
```
...
```{r echo=FALSE, fig.show="hold", out.width="49%"}
knitr::include_graphics("Viability/p_Via_pop_batch_Hoedjes.png")
knitr::include_graphics("Viability/p_Via_pop_lm_Hoedjes.png")
```
...
```{r echo=FALSE, fig.show="hold", out.width="49%"}
knitr::include_graphics("Viability/p_Via_pop_batch_Schmidt.png")
knitr::include_graphics("Viability/p_Via_pop_lm_Schmidt.png")
```
...
```{r echo=FALSE, fig.show="hold", out.width="49%"}
knitr::include_graphics("Viability/p_Via_pop_batch_StamenkovicRadak.png")
knitr::include_graphics("Viability/p_Via_pop_lm_StamenkovicRadak.png")
```
...
```{r echo=FALSE, fig.show="hold", out.width="49%"}
knitr::include_graphics("Viability/p_Via_pop_batch_Zwaan.png")
knitr::include_graphics("Viability/p_Via_pop_lm_Zwaan.png")
```
...
```{r echo=FALSE, fig.show = "hold", out.width="49%"}
knitr::include_graphics("DevelopmentTime/p_DT_P_pop_batch_Schmidt.png")
knitr::include_graphics("DevelopmentTime/p_DT_P_pop_lm_Schmidt.png")
```
...
```{r echo=FALSE, fig.show = "hold", out.width="49%"}
knitr::include_graphics("DevelopmentTime/p_DT_A_F_pop_lab.png")
knitr::include_graphics("DevelopmentTime/p_DT_A_M_pop_lab.png")
```
...
```{r echo=FALSE, fig.show = "hold", out.width="49%"}
knitr::include_graphics("DevelopmentTime/p_DT_A_F_pop_batch_Gibert.png")
knitr::include_graphics("DevelopmentTime/p_DT_A_F_pop_lm_Gibert.png")
```

```{r echo=FALSE, fig.show = "hold", out.width="49%"}
knitr::include_graphics("DevelopmentTime/p_DT_A_M_pop_batch_Gibert.png")
knitr::include_graphics("DevelopmentTime/p_DT_A_M_pop_lm_Gibert.png")
```
...
```{r echo=FALSE, fig.show = "hold", out.width="49%"}
knitr::include_graphics("DevelopmentTime/p_DT_A_F_pop_batch_Grath.png")
knitr::include_graphics("DevelopmentTime/p_DT_A_F_pop_lm_Grath.png")
```

```{r echo=FALSE, fig.show = "hold", out.width="49%"}
knitr::include_graphics("DevelopmentTime/p_DT_A_M_pop_batch_Grath.png")
knitr::include_graphics("DevelopmentTime/p_DT_A_M_pop_lm_Grath.png")
```
...
```{r echo=FALSE, fig.show = "hold", out.width="49%"}
knitr::include_graphics("DevelopmentTime/p_DT_A_F_pop_batch_Hoedjes.png")
knitr::include_graphics("DevelopmentTime/p_DT_A_F_pop_lm_Hoedjes.png")
```

```{r echo=FALSE, fig.show = "hold", out.width="49%"}
knitr::include_graphics("DevelopmentTime/p_DT_A_M_pop_batch_Hoedjes.png")
knitr::include_graphics("DevelopmentTime/p_DT_A_M_pop_lm_Hoedjes.png")
```
...
```{r echo=FALSE, fig.show = "hold", out.width="49%"}
knitr::include_graphics("DevelopmentTime/p_DT_A_F_pop_batch_Schmidt.png")
knitr::include_graphics("DevelopmentTime/p_DT_A_F_pop_lm_Schmidt.png")
```

```{r echo=FALSE, fig.show = "hold", out.width="49%"}
knitr::include_graphics("DevelopmentTime/p_DT_A_M_pop_batch_Schmidt.png")
knitr::include_graphics("DevelopmentTime/p_DT_A_M_pop_lm_Schmidt.png")
```
...
```{r echo=FALSE, fig.show = "hold", out.width="49%"}
knitr::include_graphics("DevelopmentTime/p_DT_A_F_pop_batch_StamenkovicRadak.png")
knitr::include_graphics("DevelopmentTime/p_DT_A_F_pop_lm_StamenkovicRadak.png")
```

```{r echo=FALSE, fig.show = "hold", out.width="49%"}
knitr::include_graphics("DevelopmentTime/p_DT_A_M_pop_batch_StamenkovicRadak.png")
knitr::include_graphics("DevelopmentTime/p_DT_A_M_pop_lm_StamenkovicRadak.png")
```
...
```{r echo=FALSE, fig.show = "hold", out.width="49%"}
knitr::include_graphics("DevelopmentTime/p_DT_A_F_pop_batch_Zwaan.png")
knitr::include_graphics("DevelopmentTime/p_DT_A_F_pop_lm_Zwaan.png")
```

```{r echo=FALSE, fig.show = "hold", out.width="49%"}
knitr::include_graphics("DevelopmentTime/p_DT_A_M_pop_batch_Zwaan.png")
knitr::include_graphics("DevelopmentTime/p_DT_A_M_pop_lm_Zwaan.png")
```
...
```{r echo=FALSE, fig.show = "hold", out.width="49%"}
knitr::include_graphics("DryWeight/p_DW_F_pop_lab.png")
knitr::include_graphics("DryWeight/p_DW_M_pop_lab.png")
```
...
```{r echo=FALSE, fig.show = "hold", out.width="49%"}
knitr::include_graphics("DryWeight/p_DW_F_pop_batch_Colinet.png")
knitr::include_graphics("DryWeight/p_DW_F_pop_lm_Colinet.png")
```

```{r echo=FALSE, fig.show = "hold", out.width="49%"}
knitr::include_graphics("DryWeight/p_DW_M_pop_batch_Colinet.png")
knitr::include_graphics("DryWeight/p_DW_M_pop_lm_Colinet.png")
```
...
```{r echo=FALSE, fig.show = "hold", out.width="49%"}
knitr::include_graphics("DryWeight/p_DW_F_pop_batch_Hoedjes.png")
knitr::include_graphics("DryWeight/p_DW_F_pop_lm_Hoedjes.png")
```

```{r echo=FALSE, fig.show = "hold", out.width="49%"}
knitr::include_graphics("DryWeight/p_DW_M_pop_batch_Hoedjes.png")
knitr::include_graphics("DryWeight/p_DW_M_pop_lm_Hoedjes.png")
```
...
```{r echo=FALSE, fig.show = "hold", out.width="49%"}
knitr::include_graphics("DryWeight/p_DW_F_pop_batch_Onder.png")
knitr::include_graphics("DryWeight/p_DW_F_pop_lm_Onder.png")
```

```{r echo=FALSE, fig.show = "hold", out.width="49%"}
knitr::include_graphics("DryWeight/p_DW_M_pop_batch_Onder.png")
knitr::include_graphics("DryWeight/p_DW_M_pop_lm_Onder.png")
```
...
```{r echo=FALSE, fig.show = "hold", out.width="49%"}
knitr::include_graphics("ThoraxLength/p_TL_F_pop_lab.png")
knitr::include_graphics("ThoraxLength/p_TL_M_pop_lab.png")
```
...
```{r echo=FALSE, fig.show = "hold", out.width="49%"}
knitr::include_graphics("ThoraxLength/p_TL_F_pop_batch_Kozeretska.png")
knitr::include_graphics("ThoraxLength/p_TL_F_pop_lm_Kozeretska.png")
```

```{r echo=FALSE, fig.show = "hold", out.width="49%"}
knitr::include_graphics("ThoraxLength/p_TL_M_pop_batch_Kozeretska.png")
knitr::include_graphics("ThoraxLength/p_TL_M_pop_lm_Kozeretska.png")
```
...
```{r echo=FALSE, fig.show = "hold", out.width="49%"}
knitr::include_graphics("ThoraxLength/p_TL_F_pop_batch_Posnien.png")
knitr::include_graphics("ThoraxLength/p_TL_F_pop_lm_Posnien.png")
```

```{r echo=FALSE, fig.show = "hold", out.width="49%"}
knitr::include_graphics("ThoraxLength/p_TL_M_pop_batch_Posnien.png")
knitr::include_graphics("ThoraxLength/p_TL_M_pop_lm_Posnien.png")
```
...
```{r echo=FALSE, fig.show = "hold", out.width="49%"}
knitr::include_graphics("ThoraxLength/p_TL_F_pop_batch_Ritchie.png")
knitr::include_graphics("ThoraxLength/p_TL_F_pop_lm_Ritchie.png")
```

```{r echo=FALSE, fig.show = "hold", out.width="49%"}
knitr::include_graphics("ThoraxLength/p_TL_M_pop_batch_Ritchie.png")
knitr::include_graphics("ThoraxLength/p_TL_M_pop_lm_Ritchie.png")
```
...
```{r echo=FALSE, fig.show = "hold", out.width="49%"}
knitr::include_graphics("ThoraxLength/p_TL_F_pop_batch_Schmidt.png")
knitr::include_graphics("ThoraxLength/p_TL_F_pop_lm_Schmidt.png")
```
...
```{r echo=FALSE, fig.show = "hold", out.width="49%"}
knitr::include_graphics("WingArea/p_WA_L_F_pop_lab.png")
knitr::include_graphics("WingArea/p_WA_L_M_pop_lab.png")
```
...
```{r echo=FALSE, fig.show = "hold", out.width="49%"}
knitr::include_graphics("WingArea/p_WA_L_F_pop_batch_Onder.png")
knitr::include_graphics("WingArea/p_WA_L_F_pop_lm_Onder.png")
```

```{r echo=FALSE, fig.show = "hold", out.width="49%"}
knitr::include_graphics("WingArea/p_WA_L_M_pop_batch_Onder.png")
knitr::include_graphics("WingArea/p_WA_L_M_pop_lm_Onder.png")
```
...
```{r echo=FALSE, fig.show = "hold", out.width="49%"}
knitr::include_graphics("WingArea/p_WA_L_F_pop_batch_Posnien.png")
knitr::include_graphics("WingArea/p_WA_L_F_pop_lm_Posnien.png")
```

```{r echo=FALSE, fig.show = "hold", out.width="49%"}
knitr::include_graphics("WingArea/p_WA_L_M_pop_batch_Posnien.png")
knitr::include_graphics("WingArea/p_WA_L_M_pop_lm_Posnien.png")
```
...
```{r echo=FALSE, fig.show = "hold", out.width="49%"}
knitr::include_graphics("WingArea/p_WA_L_F_pop_batch_Ritchie.png")
knitr::include_graphics("WingArea/p_WA_L_F_pop_lm_Ritchie.png")
```

```{r echo=FALSE, fig.show = "hold", out.width="49%"}
knitr::include_graphics("WingArea/p_WA_L_M_pop_batch_Ritchie.png")
knitr::include_graphics("WingArea/p_WA_L_M_pop_lm_Ritchie.png")
```
...
```{r echo=FALSE, fig.show = "hold", out.width="49%"}
knitr::include_graphics("WingArea/p_WA_L_F_pop_batch_StamenkovicRadak.png")
knitr::include_graphics("WingArea/p_WA_L_F_pop_lm_StamenkovicRadak.png")
```

```{r echo=FALSE, fig.show = "hold", out.width="49%"}
knitr::include_graphics("WingArea/p_WA_L_M_pop_batch_StamenkovicRadak.png")
knitr::include_graphics("WingArea/p_WA_L_M_pop_lm_StamenkovicRadak.png")
```
...
```{r echo=FALSE, fig.show = "hold", out.width="49%"}
knitr::include_graphics("WingArea/p_WA_R_F_pop_lab.png")
knitr::include_graphics("WingArea/p_WA_R_M_pop_lab.png")
```
...
```{r echo=FALSE, fig.show = "hold", out.width="49%"}
knitr::include_graphics("WingArea/p_WA_R_F_pop_batch_Onder.png")
knitr::include_graphics("WingArea/p_WA_R_F_pop_lm_Onder.png")
```

```{r echo=FALSE, fig.show = "hold", out.width="49%"}
knitr::include_graphics("WingArea/p_WA_R_M_pop_batch_Onder.png")
knitr::include_graphics("WingArea/p_WA_R_M_pop_lm_Onder.png")
```
...
```{r echo=FALSE, fig.show = "hold", out.width="49%"}
knitr::include_graphics("WingArea/p_WA_R_F_pop_batch_Posnien.png")
knitr::include_graphics("WingArea/p_WA_R_F_pop_lm_Posnien.png")
```

```{r echo=FALSE, fig.show = "hold", out.width="49%"}
knitr::include_graphics("WingArea/p_WA_R_M_pop_batch_Posnien.png")
knitr::include_graphics("WingArea/p_WA_R_M_pop_lm_Posnien.png")
```
...
```{r echo=FALSE, fig.show = "hold", out.width="49%"}
knitr::include_graphics("WingArea/p_WA_R_F_pop_batch_Ritchie.png")
knitr::include_graphics("WingArea/p_WA_R_F_pop_lm_Ritchie.png")
```

```{r echo=FALSE, fig.show = "hold", out.width="49%"}
knitr::include_graphics("WingArea/p_WA_R_M_pop_batch_Ritchie.png")
knitr::include_graphics("WingArea/p_WA_R_M_pop_lm_Ritchie.png")
```
...
```{r echo=FALSE, fig.show = "hold", out.width="49%"}
knitr::include_graphics("WingArea/p_WA_R_F_pop_batch_StamenkovicRadak.png")
knitr::include_graphics("WingArea/p_WA_R_F_pop_lm_StamenkovicRadak.png")
```

```{r echo=FALSE, fig.show = "hold", out.width="49%"}
knitr::include_graphics("WingArea/p_WA_R_M_pop_batch_StamenkovicRadak.png")
knitr::include_graphics("WingArea/p_WA_R_M_pop_lm_StamenkovicRadak.png")
```
...
Descriptive statistics for Fertility at the line level, without batch information:
```{r, echo=FALSE}
...
```{r echo=FALSE, fig.show = "hold", out.width="49%"}
knitr::include_graphics("Fecundity/p_Fec_F_pop_lab.png")
```
...
```{r echo=FALSE, fig.show = "hold", out.width="49%"}
knitr::include_graphics("Fecundity/p_Fec_F_pop_batch_Billeter.png")
knitr::include_graphics("Fecundity/p_Fec_F_pop_lm_Billeter.png")
```
...
```{r echo=FALSE, fig.show = "hold", out.width="49%"}
knitr::include_graphics("Fecundity/p_Fec_F_pop_batch_Fricke.png")
knitr::include_graphics("Fecundity/p_Fec_F_pop_lm_Fricke.png")
```
...
```{r echo=FALSE, fig.show = "hold", out.width="49%"}
knitr::include_graphics("Lifespan/p_LSP_F_pop_batch_Flatt.png")
knitr::include_graphics("Lifespan/p_LSP_F_pop_lm_Flatt.png")
```

```{r echo=FALSE, fig.show = "hold", out.width="49%"}
knitr::include_graphics("Lifespan/p_LSP_M_pop_batch_Flatt.png")
knitr::include_graphics("Lifespan/p_LSP_M_pop_lm_Flatt.png")
```
...
```
```{r echo=FALSE, fig.show = "hold", out.width="49%"}
knitr::include_graphics("Lifespan/p_LSL_F_pop_batch_Parsch.png")
knitr::include_graphics("Lifespan/p_LSL_F_pop_lm_Parsch.png")
```

```{r echo=FALSE, fig.show = "hold", out.width="49%"}
knitr::include_graphics("Lifespan/p_LSL_M_pop_batch_Parsch.png")
knitr::include_graphics("Lifespan/p_LSL_M_pop_lm_Parsch.png")
```
...
```{r echo=FALSE, fig.show = "hold", out.width="49%"}
knitr::include_graphics("Lifespan/p_LSL_F_pop_batch_Pasyukova.png")
knitr::include_graphics("Lifespan/p_LSL_F_pop_lm_Pasyukova.png")
```

```{r echo=FALSE, fig.show = "hold", out.width="49%"}
knitr::include_graphics("Lifespan/p_LSL_M_pop_batch_Pasyukova.png")
knitr::include_graphics("Lifespan/p_LSL_M_pop_lm_Pasyukova.png")
```
...
```{r echo=FALSE, fig.show = "hold", out.width = "49%"}
knitr::include_graphics("ColdShock/p_CSM_F_pop_lab.png")
knitr::include_graphics("ColdShock/p_CSM_M_pop_lab.png")
```
##### Gonzalez Lab
...
```{r echo=FALSE, fig.show = "hold", out.width = "49%"}
knitr::include_graphics("ColdShock/p_CSM_F_pop_batch_Gonzalez.png")
knitr::include_graphics("ColdShock/p_CSM_F_pop_lm_Gonzalez.png")
```

```{r echo=FALSE, fig.show = "hold", out.width = "49%"}
knitr::include_graphics("ColdShock/p_CSM_M_pop_batch_Gonzalez.png")
knitr::include_graphics("ColdShock/p_CSM_M_pop_lm_Gonzalez.png")
```
...
```{r echo=FALSE, fig.show = "hold", out.width = "49%"}
knitr::include_graphics("ColdShock/p_CSM_F_pop_batch_Kozeretska.png")
knitr::include_graphics("ColdShock/p_CSM_F_pop_lm_Kozeretska.png")
```

```{r echo=FALSE, fig.show = "hold", out.width = "49%"}
knitr::include_graphics("ColdShock/p_CSM_M_pop_batch_Kozeretska.png")
knitr::include_graphics("ColdShock/p_CSM_M_pop_lm_Kozeretska.png")
```
...
```{r echo=FALSE, fig.show = "hold", out.width = "49%"}
knitr::include_graphics("ColdShock/p_CSM_F_pop_batch_Vieira.png")
knitr::include_graphics("ColdShock/p_CSM_F_pop_lm_Vieira.png")
```

```{r echo=FALSE, fig.show = "hold", out.width = "49%"}
knitr::include_graphics("ColdShock/p_CSM_M_pop_batch_Vieira.png")
knitr::include_graphics("ColdShock/p_CSM_M_pop_lm_Vieira.png")
```
...
```{r echo=FALSE, fig.show = "hold", out.width = "49%"}
knitr::include_graphics("ChillComa/p_CCRT_F_pop_lab.png")
knitr::include_graphics("ChillComa/p_CCRT_M_pop_lab.png")
```
...
```{r echo=FALSE, fig.show = "hold", out.width = "49%"}
knitr::include_graphics("ChillComa/p_CCRT_F_pop_batch_Mensch.png")
knitr::include_graphics("ChillComa/p_CCRT_F_pop_lm_Mensch.png")
```

```{r echo=FALSE, fig.show = "hold", out.width = "49%"}
knitr::include_graphics("ChillComa/p_CCRT_M_pop_batch_Mensch.png")
knitr::include_graphics("ChillComa/p_CCRT_M_pop_lm_Mensch.png")
```
...
```{r echo=FALSE, fig.show = "hold", out.width = "49%"}
knitr::include_graphics("ChillComa/p_CCRT_F_pop_batch_Vieira.png")
knitr::include_graphics("ChillComa/p_CCRT_F_pop_lm_Vieira.png")
```

```{r echo=FALSE, fig.show = "hold", out.width = "49%"}
knitr::include_graphics("ChillComa/p_CCRT_M_pop_batch_Vieira.png")
knitr::include_graphics("ChillComa/p_CCRT_M_pop_lm_Vieira.png")
```
...
_Females_
```{r}
coxme_anova$CCRT_F_Mensch_coxme_pop
```
...
_Males_
```{r}
coxme_anova$CCRT_M_Mensch_coxme_pop
```
...
_Females_
```{r}
coxme_anova$CCRT_F_Vieira_coxme_pop
```
...
_Males_
```{r}
coxme_anova$CCRT_M_Vieira_coxme_pop
```
...
```{r echo=FALSE, fig.show = "hold", out.width = "49%"}
knitr::include_graphics("HeatShock/p_HSM_F_pop_lab.png")
knitr::include_graphics("HeatShock/p_HSM_M_pop_lab.png")
```
...
```{r echo=FALSE, fig.show = "hold", out.width = "49%"}
knitr::include_graphics("HeatShock/p_HSM_F_pop_batch_Parsch.png")
knitr::include_graphics("HeatShock/p_HSM_F_pop_lm_Parsch.png")
```

```{r echo=FALSE, fig.show = "hold", out.width = "49%"}
knitr::include_graphics("HeatShock/p_HSM_M_pop_batch_Parsch.png")
knitr::include_graphics("HeatShock/p_HSM_M_pop_lm_Parsch.png")
```
...
```{r echo=FALSE, fig.show = "hold", out.width = "49%"}
knitr::include_graphics("HeatShock/p_HSM_F_pop_batch_Vieira.png")
knitr::include_graphics("HeatShock/p_HSM_F_pop_lm_Vieira.png")
```

```{r echo=FALSE, fig.show = "hold", out.width = "49%"}
knitr::include_graphics("HeatShock/p_HSM_M_pop_batch_Vieira.png")
knitr::include_graphics("HeatShock/p_HSM_M_pop_lm_Vieira.png")
```
...
```{r echo=FALSE, fig.show = "hold", out.width = "49%"}
knitr::include_graphics("Diapause/p_Dia_F_pop_lab.png")
```

##### Bergland Lab
```{r}
glmers_anova$Dia_Bergland_glmer_pop
```

```{r}
glmers_sum$Dia_Bergland_glmer_pop
```

```{r echo=FALSE, fig.show = "hold", out.width = "49%"}
knitr::include_graphics("Diapause/p_Dia_F_pop_batch_Bergland.png")
knitr::include_graphics("Diapause/p_Dia_F_pop_lm_Bergland.png")
```

##### Flatt Lab

```{r}
glmers_anova$Dia_Flatt_glmer_pop
```

```{r}
glmers_sum$Dia_Flatt_glmer_pop
```

```{r echo=FALSE, fig.show = "hold", out.width = "49%"}
knitr::include_graphics("Diapause/p_Dia_F_pop_batch_Flatt.png")
knitr::include_graphics("Diapause/p_Dia_F_pop_lm_Flatt.png")
```

##### Schlotterer Lab

```{r}
glmers_anova$Dia_Schlotterer_glmer_pop
```

```{r}
glmers_sum$Dia_Schlotterer_glmer_pop
```

```{r echo=FALSE, fig.show = "hold", out.width = "49%"}
knitr::include_graphics("Diapause/p_Dia_F_pop_batch_Schlotterer.png")
knitr::include_graphics("Diapause/p_Dia_F_pop_lm_Schlotterer.png")
```
...
```{r fig.show = "hold", out.width = "49%", fig.align = "default", echo = FALSE}
knitr::include_graphics("LinearModelsPop/Diapause/by_lab_models_residuals/Dia_Bergland_glmer_pop_hist_residuals.png")

knitr::include_graphics("LinearModelsPop/Diapause/by_lab_models_residuals/Dia_Bergland_glmer_pop_qq_plot_residuals.png")
```

##### Flatt Lab

```{r fig.show = "hold", out.width = "49%", fig.align = "default", echo = FALSE}
knitr::include_graphics("LinearModelsPop/Diapause/by_lab_models_residuals/Dia_Flatt_glmer_pop_hist_residuals.png")

knitr::include_graphics("LinearModelsPop/Diapause/by_lab_models_residuals/Dia_Flatt_glmer_pop_qq_plot_residuals.png")
```

##### Schlotterer Lab

```{r fig.show = "hold", out.width = "49%", fig.align = "default", echo = FALSE}
knitr::include_graphics("LinearModelsPop/Diapause/by_lab_models_residuals/Dia_Schlotterer_glmer_pop_hist_residuals.png")

knitr::include_graphics("LinearModelsPop/Diapause/by_lab_models_residuals/Dia_Schlotterer_glmer_pop_qq_plot_residuals.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("Starvation/p_SR_F_pop_lab.png")
knitr::include_graphics("Starvation/p_SR_M_pop_lab.png")
```
...
```{r echo=FALSE, fig.show = "hold", out.width = "49%"}
knitr::include_graphics("Starvation/p_SR_F_pop_batch_Gonzalez.png")
knitr::include_graphics("Starvation/p_SR_F_pop_lm_Gonzalez.png")
```

```{r echo=FALSE, fig.show = "hold", out.width = "49%"}
knitr::include_graphics("Starvation/p_SR_M_pop_batch_Gonzalez.png")
knitr::include_graphics("Starvation/p_SR_M_pop_lm_Gonzalez.png")
```
...
```{r echo=FALSE, fig.show = "hold", out.width = "49%"}
knitr::include_graphics("Starvation/p_SR_F_pop_batch_Onder.png")
knitr::include_graphics("Starvation/p_SR_F_pop_lm_Onder.png")
```

```{r echo=FALSE, fig.show = "hold", out.width = "49%"}
knitr::include_graphics("Starvation/p_SR_M_pop_batch_Onder.png")
knitr::include_graphics("Starvation/p_SR_M_pop_lm_Onder.png")
```
...
```{r echo=FALSE, fig.show = "hold", out.width = "49%"}
knitr::include_graphics("Starvation/p_SR_F_pop_batch_Pasyukova.png")
knitr::include_graphics("Starvation/p_SR_F_pop_lm_Pasyukova.png")
```

```{r echo=FALSE, fig.show = "hold", out.width = "49%"}
knitr::include_graphics("Starvation/p_SR_M_pop_batch_Pasyukova.png")
knitr::include_graphics("Starvation/p_SR_M_pop_lm_Pasyukova.png")
```
...
```{r echo=FALSE, fig.show = "hold", out.width = "49%"}
knitr::include_graphics("Pigmentation/p_Pgm_T4_F_pop_batch_Abbott.png")
knitr::include_graphics("Pigmentation/p_Pgm_T4_F_pop_lm_Abbott.png")
```
...
```{r echo=FALSE, fig.show = "hold", out.width = "49%"}
knitr::include_graphics("Pigmentation/p_Pgm_T5_F_pop_batch_Abbott.png")
knitr::include_graphics("Pigmentation/p_Pgm_T5_F_pop_lm_Abbott.png")
```
...
```{r echo=FALSE, fig.show = "hold", out.width = "49%"}
knitr::include_graphics("Pigmentation/p_Pgm_T6_F_pop_batch_Abbott.png")
knitr::include_graphics("Pigmentation/p_Pgm_T6_F_pop_lm_Abbott.png")
```
...
```{r echo=FALSE, fig.show = "hold", out.width = "49%"}
knitr::include_graphics("Pigmentation/p_Pgm_Total_F_pop_batch_Abbott.png")
knitr::include_graphics("Pigmentation/p_Pgm_Total_F_pop_lm_Abbott.png")
```
...
```{r echo=FALSE, fig.show = "hold", out.width = "49%"}
knitr::include_graphics("Pigmentation/p_Pgm_T4_F_pop_batch_Gibert.png")
knitr::include_graphics("Pigmentation/p_Pgm_T4_F_pop_lm_Gibert.png")
```
...
```{r echo=FALSE, fig.show = "hold", out.width = "49%"}
knitr::include_graphics("Pigmentation/p_Pgm_T5_F_pop_batch_Gibert.png")
knitr::include_graphics("Pigmentation/p_Pgm_T5_F_pop_lm_Gibert.png")
```
...
```{r echo=FALSE, fig.show = "hold", out.width = "49%"}
knitr::include_graphics("Pigmentation/p_Pgm_T6_F_pop_batch_Gibert.png")
knitr::include_graphics("Pigmentation/p_Pgm_T6_F_pop_lm_Gibert.png")
```
...
```{r echo=FALSE, fig.show = "hold", out.width = "49%"}
knitr::include_graphics("Pigmentation/p_Pgm_Total_F_pop_batch_Gibert.png")
knitr::include_graphics("Pigmentation/p_Pgm_Total_F_pop_lm_Gibert.png")
```
...
```{r echo=FALSE, fig.show = "hold", out.width = "49%"}
knitr::include_graphics("Pigmentation/p_Pgm_T4_F_pop_batch_Schmidt.png")
knitr::include_graphics("Pigmentation/p_Pgm_T4_F_pop_lm_Schmidt.png")
```
...
```{r echo=FALSE, fig.show = "hold", out.width = "49%"}
knitr::include_graphics("Pigmentation/p_Pgm_T5_F_pop_batch_Schmidt.png")
knitr::include_graphics("Pigmentation/p_Pgm_T5_F_pop_lm_Schmidt.png")
```
...
```{r echo=FALSE, fig.show = "hold", out.width = "49%"}
knitr::include_graphics("Pigmentation/p_Pgm_T6_F_pop_batch_Schmidt.png")
knitr::include_graphics("Pigmentation/p_Pgm_T6_F_pop_lm_Schmidt.png")
```
...
```{r echo=FALSE, fig.show = "hold", out.width = "49%"}
knitr::include_graphics("Pigmentation/p_Pgm_Total_F_pop_batch_Schmidt.png")
knitr::include_graphics("Pigmentation/p_Pgm_Total_F_pop_lm_Schmidt.png")
```
...
Descriptive statistics at the line level, with batch information:
```{r, echo=FALSE}
DT::datatable(table_line_wbatch$PR_HR, options = list(pageLength = 10)) %>% formatRound(6:12, 3)
```

Descriptive statistics at the line level, without batch information:
```{r, echo=FALSE}
DT::datatable(table_line_wobatch$PR_HR, options = list(pageLength = 10)) %>% formatRound(5:11, 3)
```

Descriptive statistics at the population level, with batch information:
```{r, echo=FALSE}
DT::datatable(table_pop_wbatch$PR_HR, options = list(pageLength = 10))  %>% formatRound(5:11, 3)
```

Descriptive statistics at the population level, without batch information:
```{r, echo=FALSE}
DT::datatable(table_pop_wobatch$PR_HR, options = list(pageLength = 10)) %>% formatRound(4:10, 3)
```

##### Plots and Linear Models by Lab

```{r echo=FALSE, fig.show = "hold", out.width="49%"}
knitr::include_graphics("ParasitoidResistance/p_PR_HR_pop_lab.png")
```

###### Hrcek Lab

```{r}
glmers_anova$PR_HR_Hrcek_glmer_pop
```

```{r}
glmers_sum$PR_HR_Hrcek_glmer_pop
```

```{r echo=FALSE, fig.show = "hold", out.width="49%"}
knitr::include_graphics("ParasitoidResistance/p_PR_HR_pop_batch_Hrcek.png")
knitr::include_graphics("ParasitoidResistance/p_PR_HR_pop_lm_Hrcek.png")
```
...
```{r fig.show = "hold", out.width = "49%", fig.align = "default", echo = FALSE}
knitr::include_graphics("LinearModelsPop/ParasitoidResistance/by_lab_models_residuals/PR_HR_Hrcek_glmer_pop_hist_residuals.png")

knitr::include_graphics("LinearModelsPop/ParasitoidResistance/by_lab_models_residuals/PR_HR_Hrcek_glmer_pop_qq_plot_residuals.png")
```
...
- Blanca MJ, Alarcón R, Arnau J, Bono R, Bendayan R. 2017. Non-normal data: Is ANOVA still a valid option? Psicothema 29:552-557.

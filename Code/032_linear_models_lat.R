...
##### Colinet Lab
DW_lmers_lat$DW_F_Colinet_lmer_lat <- lmer(DW_micrograms ~ Latitude + (1|Population) + (1|Line:Population), data = filter(droseu$dw, Supervisor.PI == "Colinet" & Sex == "F"))

##### Hoedjes Lab, not converging, removed Population
DW_lmers_lat$DW_F_Hoedjes_lmer_lat <- lmer(DW_micrograms ~ Latitude + (1|Line:Population), data = filter(droseu$dw, Supervisor.PI == "Hoedjes" & Sex == "F"))

##### Onder Lab
DW_lmers_lat$DW_F_Onder_lmer_lat <- lmer(DW_micrograms ~ Latitude + (1|Population) + (1|Line:Population), data = filter(droseu$dw, Supervisor.PI == "Onder" & Sex == "F"))


## Males

##### Colinet Lab
DW_lmers_lat$DW_M_Colinet_lmer_lat <- lmer(DW_micrograms ~ Latitude + (1|Population) + (1|Line:Population), data = filter(droseu$dw, Supervisor.PI == "Colinet" & Sex == "M"))

##### Hoedjes Lab, singular fit removed Population
DW_lmers_lat$DW_M_Hoedjes_lmer_lat <- lmer(DW_micrograms ~ Latitude + (1|Line:Population), data = filter(droseu$dw, Supervisor.PI == "Hoedjes" & Sex == "M"))

##### Onder Lab
DW_lmers_lat$DW_M_Onder_lmer_lat <- lmer(DW_micrograms ~ Latitude + (1|Population) + (1|Line:Population), data = filter(droseu$dw, Supervisor.PI == "Onder" & Sex == "M"))
...
#### Vieira Lab
CCRT_lmers_lat$CCRT_F_Vieira_lmer_lat <- lmer(CCRT_seconds ~ Latitude + (1|Population) + (1|Line:Population), data = filter(droseu$ccrt, Censor == "0" & Supervisor.PI == "Vieira" & Sex == "F"))

#### Mensch Lab
CCRT_lmers_lat$CCRT_F_Mensch_lmer_lat <- lmer(CCRT_seconds ~ Latitude + (1|Population) + (1|Line:Population), data = filter(droseu$ccrt, Censor == "0" & Supervisor.PI == "Mensch" & Sex == "F"))


## Males

#### Vieira Lab
CCRT_lmers_lat$CCRT_M_Vieira_lmer_lat <- lmer(CCRT_seconds ~ Latitude + (1|Population) + (1|Line:Population), data = filter(droseu$ccrt, Censor == "0" & Supervisor.PI == "Vieira" & Sex == "M"))

#### Mensch Lab
CCRT_lmers_lat$CCRT_M_Mensch_lmer_lat <- lmer(CCRT_seconds ~ Latitude + (1|Population) + (1|Line:Population), data = filter(droseu$ccrt, Censor == "0" & Supervisor.PI == "Mensch" & Sex == "M"))
...
#### Bergland Lab
Dia_lmers_lat$Dia_Bergland_lmer_lat <- lmer(Prop_Max_Stage9_asin ~ Latitude + (1|Population) + (1|Line:Population), data = filter(droseu$dia, Supervisor.PI == "Bergland"))
...
#### Schlotterer Lab
Dia_lmers_lat$Dia_Schlotterer_lmer_lat <- lmer(Prop_Max_Stage9_asin ~ Latitude + (1|Population) + (1|Line:Population), data = filter(droseu$dia, Supervisor.PI == "Schlotterer"))
...
Dia_glmers_lat <- foreach(pi = unique(dia$Supervisor.PI)) %do% {
  m1 <- glmer(Prop_Max_Stage9 ~ Latitude + (1|Population) + (1|Line:Population), weights = n, family = binomial(), data = filter(dia, Supervisor.PI == pi)) 
...
saveRDS(all_lmers_lat_anova, file = file.path(lmer_dir, "all_lmers_lat_anova_list.rds"))
